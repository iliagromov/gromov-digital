...
const DebugGridComponent: FC<DebugGridComponentProps> = ({
  isVisible = false,
}) => {
  ...
  return (
    <>
      {isVisible && (
        <>
          <button
            className={cn("debugGrid-btn", {
              "debugGrid-btn__remove": debugGridIsOpen,
              "debugGrid-btn__create": !debugGridIsOpen,
            })}
            onClick={onGrid}
          ></button>

          <div
            className={cn("debugGrid", "debugGrid__z-index", {
              debugGrid__hidden: !debugGridIsOpen,
            })}
          >
